                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Add Agents Detail</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal">
                                      <fieldset>
                                        <legend>Add Agents Detail</legend>
									  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
									  
									  <tr>
                                         <td><label class="control-label" for="focusedInput">City:</label></td>
                                         <td> 
										...
										<tr>
                                         <td><label class="control-label" for="focusedInput">Section:</label></td>
                                         <td> 
                                            <select id="selectError">
                                              <option>1</option>
                                              <option>2</option>
										...
										<tr>
                                         <td><label class="control-label" for="focusedInput">No. Of Bedrooms:</label></td>
                                         <td> 
                                            <select id="selectError">
                                              <option>1</option>
                                              <option>2</option>
