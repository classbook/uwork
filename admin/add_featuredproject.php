...
include("dbconfig.php");
 if(isset($_POST['submit'])) {
		...
		$location1 = $_SERVER['DOCUMENT_ROOT'] .'/featuredProjectImage/'.$short_code1.$_FILES['upload']['name'][$key];
		move_uploaded_file($file_tmp, $location1);
		
	$re= mysql_query("INSERT INTO featured_project(image, title, subtitle)VALUES
