...
$r1 = mysql_query("select * from serviceDetail where id=1");
$row=mysql_fetch_array($r1);
$r = mysql_query('update serviceDetail set content="'.$_POST['content'].'" where id=1');
?>
		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Service Detail</div>
		                            </div>
		                            <form method='post' action=''>
		                            <div class="block-content collapse in">
		                               <textarea name='content' id="ckeditor_full"><?php echo $row['content'];?></textarea>
									   <br/>
