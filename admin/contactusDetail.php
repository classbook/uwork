...
$r1 = mysql_query("select * from contactus where id=1");
$row=mysql_fetch_array($r1);
$r = mysql_query('update contactus set content="'.$_POST['content'].'" where id=1');
?>
		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">ContactUS Detail</div>
		                            </div>
