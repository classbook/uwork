...
{
$r = mysql_query('update aboutus set content="'.$_POST['content'].'" where id=1');
$success_msg = "Successfully updated about us page content.";
}
$r1 = mysql_query("select * from aboutus where id=1");
                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i> Avi Admin <i class="caret"></i>
		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">AboutUS Detail</div>
		                            </div>
									<?php
									if ($success_msg!=null):?>
		                            ...
		                            <div class="block-content collapse in">
										<input type="hidden" name="aboutus" value="true" />
